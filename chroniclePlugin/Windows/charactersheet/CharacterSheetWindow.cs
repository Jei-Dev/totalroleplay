...
public class CharacterSheetWindow : Window
{
	...
	public CharacterSheetWindow(CharacterConfiguration _charConfig, CharacterConfiguration charConfig) : base("Character Sheet###V0.0.1", ImGuiWindowFlags.NoCollapse | ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoResize)
	{
		charConfig = _charConfig;
		this.Size = new Vector2(730, 585);
