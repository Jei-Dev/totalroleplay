...
namespace chroniclePlugin
{
	public sealed class Plugin : IDalamudPlugin
	{
		...
		public Plugin(DalamudPluginInterface pluginInterface)
		{
			...
			characterSheetWindow = new CharacterSheetWindow(characterConfiguration, charConfig: characterConfiguration);
			...
			commandHandler = new CommandHandler(this, dalamud.commandHandler, questService, dalamud.commandManager, dalamud.loggingService);
